...
// packages/isomorphic/protocolMetainfo.ts — a machine-generated data table
// (by generate_channels.js, not hand-written) mapping every protocol
// "Class.method" call to display metadata: a human title template, its
// `ActionGroup` ('configuration' | 'route' | 'getter'), and flags like
// `snapshot`/`input`/`potentiallyClosesScope`. ./model-util.ts uses it (via
// ./protocol-formatter.ts) to compute each action's `group` (feeding
// `actionCounters`) and to render human titles in `renderActionTree`.
//
// VENDOR-NOTE: kept verbatim, including single-quoted strings — several
// title templates embed literal double quotes (e.g. `Fill "{text}"`), so a
// naive quote-style rewrite would corrupt them; left for the repo's
// formatter (oxfmt, via `pnpm check:fix`) to normalize safely.
// Only the license-header comment above and this provenance note were added;
// the "do not edit manually" generator comment from the original file was
// dropped since it no longer applies once vendored (this copy IS manually
// maintained — re-pull from upstream on a Playwright version bump instead).

export type MethodMetainfo = {
  internal?: boolean;
  title?: string;
  slowMo?: boolean;
  snapshot?: boolean;
  pause?: boolean;
  isAutoWaiting?: boolean;
  input?: boolean;
...
export const methodMetainfo = new Map<string, MethodMetainfo>([
  ...
  [
    ...
    { title: "Get storage state", group: "configuration" },
  ],
  ["APIRequestContext.disposeAPIResponse", { internal: true }],
  [
    "APIRequestContext.dispose",
    { internal: true, potentiallyClosesScope: true },
  ],
  ...
  [
    "Browser.close",
    { title: "Close browser", pause: true, potentiallyClosesScope: true },
  ],
  ...
  [
    ...
    { title: "Close context", pause: true, potentiallyClosesScope: true },
  ],
  ...
  [
    ...
    { title: "Set storage state", group: "configuration" },
  ],
  ...
  [
    ...
    { title: "Evaluate", snapshot: true, pause: true },
  ],
  [
    "Frame.addScriptTag",
    { title: "Add script tag", snapshot: true, pause: true },
  ],
  [
    "Frame.addStyleTag",
    { title: "Add style tag", snapshot: true, pause: true },
  ],
  ...
  [
    "Frame.dispatchEvent",
    { title: 'Dispatch "{type}"', slowMo: true, snapshot: true, pause: true },
  ],
  [
  ...
  [
    "Frame.focus",
    { title: "Focus", slowMo: true, snapshot: true, pause: true },
  ],
  ...
  [
    "Frame.goto",
    { title: 'Navigate to "{url}"', slowMo: true, snapshot: true, pause: true },
  ],
  [
    "Frame.hover",
    {
  ...
  [
    ...
    { title: "Wait for function", snapshot: true, pause: true },
  ],
  ["Frame.waitForSelector", { title: "Wait for selector", snapshot: true }],
  [
    "Frame.expect",
    { title: 'Expect "{expression}"', snapshot: true, pause: true },
  ],
  ...
  [
    ...
    { title: "Get bounding box", snapshot: true, pause: true },
  ],
  [
    "ElementHandle.check",
    {
  ...
  [
    ...
    { title: "Dispatch event", slowMo: true, snapshot: true, pause: true },
  ],
  [
    "ElementHandle.fill",
    {
  ...
  [
    ...
    { title: "Query selector all", snapshot: true },
  ],
  [
    "ElementHandle.screenshot",
    { title: "Screenshot", snapshot: true, pause: true },
  ],
  [
  ...
  [
    ...
    { title: "Wait for state", snapshot: true, pause: true },
  ],
  [
    "ElementHandle.waitForSelector",
    { title: "Wait for selector", snapshot: true },
  ],
  ...
  [
    "Page.close",
    { title: "Close page", pause: true, potentiallyClosesScope: true },
  ],
  ...
  [
    "Page.emulateMedia",
    { title: "Emulate media", snapshot: true, pause: true },
  ],
  ...
  [
    ...
    { title: "Expect screenshot", snapshot: true, pause: true },
  ],
  ...
  [
    ...
    { title: "Set viewport size", snapshot: true, pause: true },
  ],
  [
    "Page.keyboardDown",
    {
  ...
  [
    "Page.mouseClick",
    { title: "Click", slowMo: true, snapshot: true, pause: true, input: true },
  ],
  [
    "Page.mouseWheel",
    {
  ...
  [
    "Page.touchscreenTap",
    { title: "Tap", slowMo: true, snapshot: true, pause: true, input: true },
  ],
  ...
  [
    ...
    { title: "Cancel pick locator", group: "configuration" },
  ],
  [
    "Page.hideHighlight",
  ...
  [
    ...
    { title: "Show overlay", group: "configuration" },
  ],
  [
    "Page.screencastRemoveOverlay",
    { title: "Remove overlay", group: "configuration" },
  ],
  [
    "Page.screencastChapter",
    { title: "Show chapter overlay", group: "configuration" },
  ],
  [
    "Page.screencastSetOverlayVisible",
    { title: "Set overlay visibility", group: "configuration" },
  ],
  [
    "Page.screencastShowActions",
    { title: "Show actions", group: "configuration" },
  ],
  [
    "Page.screencastHideActions",
    { title: "Remove actions", group: "configuration" },
  ],
  [
    "Page.screencastStart",
    { title: "Start screencast", group: "configuration" },
  ],
  ...
  [
    ...
    { title: "Set WebStorage item", group: "configuration" },
  ],
  [
    "Page.webStorageRemoveItem",
    { title: "Remove WebStorage item", group: "configuration" },
  ],
  [
    "Page.webStorageClear",
    { title: "Clear WebStorage", group: "configuration" },
  ],
  ...
  [
    ...
    { title: "Pause on next call", group: "configuration" },
  ],
  ...
  [
    "Worker.disconnect",
    { title: "Disconnect from worker", potentiallyClosesScope: true },
  ],
...
export function getMetainfo(metadata: {
  type: string;
  method: string;
}): MethodMetainfo | undefined {
