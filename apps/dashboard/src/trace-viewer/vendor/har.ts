...
// packages/trace/src/har.ts — verbatim (no adaptation needed: this file has
// no imports of its own). Used by ./snapshot.ts (ResourceSnapshot = HAR Entry)
// for the `resources` collection surfaced by ./model-util.ts.
