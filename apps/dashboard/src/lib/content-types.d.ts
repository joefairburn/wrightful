 ...
 */
export declare const SAFE_CONTENT_TYPES: ReadonlySet<string>;
export declare function isSafeContentType(value: string): boolean;
/**
 ...
 */
export declare function safeContentType(value: string): string;
