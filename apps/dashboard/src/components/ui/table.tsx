  ...
  return (
    <th
      className={cn(
        ...
        "h-10 whitespace-nowrap px-2.5 text-left align-middle text-12 font-medium tracking-[0.1px] text-fg-3 leading-none has-[[role=checkbox]]:w-px last:has-[[role=checkbox]]:ps-0 first:has-[[role=checkbox]]:pe-0",
        className,
      )}
