  ...
  return (
    <AutocompletePrimitive.Portal {...portalProps}>
      ...
      >
        <span
          className={cn(
            "relative flex max-h-full min-w-(--anchor-width) max-w-(--available-width) origin-(--transform-origin) rounded-lg border bg-popover not-dark:bg-clip-padding shadow-lg/5 transition-[scale,opacity] has-data-[starting-style]:scale-98 has-data-[starting-style]:opacity-0 has-data-[ending-style]:scale-98 has-data-[ending-style]:opacity-0 before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] before:shadow-[0_1px_--theme(--color-black/4%)] dark:before:shadow-[0_-1px_--theme(--color-white/6%)]",
            className,
          )}
        >
